...
public class ViewServiceOrder extends javax.swing.JPanel {
    ...
    public ViewServiceOrder(ServiceOrderMain serviceOrderMain,JPanel pan) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jCalendarCombo1.setBounds(440, 20, 240, 30);
        jLayeredPane1.add(jCalendarCombo1, javax.swing.JLayeredPane.DEFAULT_LAYER);
    ...
    private void viewServiceOrder() {
        ...
        try {
            ...
            Logger.getLogger(ViewServiceOrder.class.getName()).log(Level.SEVERE, null, ex);
        ...
        jCalendarCombo1.setDate(setDateTime(serviceOrder.getOrder_Date()));
