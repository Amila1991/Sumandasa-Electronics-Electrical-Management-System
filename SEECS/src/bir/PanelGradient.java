...
public class PanelGradient extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (isOpaque()) {
            ...
            Color light = new Color(1F, 1F, 0.5F, 0.5F);
            Color dark = new Color(1F, 0.5F, 0.5F, 0.0F);
            ...
            paint = new GradientPaint(0, getHeight(),
                    light, 0, getHeight() - height, dark);
            path = new GeneralPath();
            path.moveTo(0, getHeight());
            path.lineTo(0, getHeight() - height);
            path.curveTo(0, getHeight() - height, width / 2,
                    getHeight() - height / 2, width, getHeight() - height);
    ...
    private void setUpGradient() {
        gradientImage = new BufferedImage(1, getHeight(),
        ...
        GradientPaint paint = new GradientPaint(0, 0,
                Color.ORANGE, 0, getHeight(), Color.WHITE);
