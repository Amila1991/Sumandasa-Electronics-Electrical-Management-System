...
public class SoldItem {
    ...
    public SoldItem(String Serial_No, String Model_No, String Item_Description, String Item_Brand_Name, double Receive_price, double Issue_price, int Item_Qty, double Amount, String Warranty_Period, String Order_ID) {
